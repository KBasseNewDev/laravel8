...
@section('content')
	<div class="sidebar-nav sidebar-expand-md sidebar-light bg-white shadow-sm" style="width: 300px; position: absolute; top: 58px; bottom: -300px; border-radius: 10px; box-shadow: 5px 7px 10px;">
        ...
        <ul class="sidebar-nav mr-auto" style="position: relative; list-style: none;">
        	<li class="">
        		<a class="" href="" style="display: flex; text-decoration: none; font-family: arial; font-size: 1.15em; align-items: left; color: #000; padding: 10px 10px; border-radius: 0 30px;">Ajouter Nouvel Employe</a>
        	</li>
            <li class="dropdown">
            	...
            	<ul class="" style="position: relative; list-style: none;">
            		...
            		<li class="">
            			<a class="" href="#" style="display: flex; text-decoration: none; font-family: arial; font-size: 1.15em; align-items: left; color: #000; padding: 10px 10px; border-radius: 0 30px;">Employes</a>
            		</li>
