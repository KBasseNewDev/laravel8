	...
	<div class="container d-flex align-items-center justify-content-center">
                  <div class="row">
                        ...
                        <div class="col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1">
                              <h2 style="text-align: center !important;">Ajouter Nouveau Service</h2>
                              <form action="{{route('services.store') }}" method="POST" validate>
                                    {{ csrf_field() }}
                                    <div class="form-group {{ $errors->has('nomService') ? 'has-error' : '' }}">
                                          <label for="nomService" class="control-label">Nom Du Service</label>
                                          <input type="text" name="nomService" value="{{old('nomService')}}" id="nomService" class="form-control" required="required">
