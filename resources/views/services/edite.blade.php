	...
	<div class="container d-flex align-items-center justify-content-center">
                  <div class="row">
                        ...
                        <div class="col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1">
                              <h2 style="text-align: center !important;">Modifier Service</h2>
                              <form action="{{route('services.update', ['service'=>$service->idService]) }}" method="POST" validate>
                                    {{ csrf_field() }}

                                    {{ method_field('PUT')}}


                                    <div class="form-group {{ $errors->has('nomService') ? 'has-error' : '' }}">
                                          <label for="nomService" class="control-label">Nom Du Service</label>
                                          <input type="text" name="nomService" value="{{$service->nomService??old('nomService')}}" id="Service" class="form-control" required="required">
                                          {!! $errors->first('nomService', '<span class="help-block">:message</span>') !!}
                                    </div>
                                    <br>
