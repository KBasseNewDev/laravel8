	...
	<div class="container d-flex align-items-center justify-content-center">
                  <div class="row">
                        ...
                        <div class="col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1">
                              <h2 style="text-align: center !important;">Ajouter Nouvelle Prime</h2>
                              <form action="{{route('primes.store') }}" method="POST" validate>
                                    {{ csrf_field() }}
                                    <div class="form-group {{ $errors->has('nomPrime') ? 'has-error' : '' }}">
                                          <label for="nomPrime" class="control-label">Nom Prime</label>
                                          <input type="text" name="nomPrime" value="{{old('nomPrime')}}" id="nomPrime" class="form-control" required="required">
                                          {!! $errors->first('nomPrime', '<span class="help-block">:message</span>') !!}
                                    </div>
                                    <div class="form-group">
                                          <label for="montantPrime" class="control-label">Montant De La Prime</label>
                                          <input type="text" name="montantPrime" value="{{old('montantPrime')}}" id="montantPrime" class="form-control" required="required">
                                    </div>
                                    <br>
                                    <div class="form-group">
