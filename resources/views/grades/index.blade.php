...
@section('content')
	...
	<h1 style="text-align: center;">Liste des Grades</h1>
	<table style="align-self: center; float: right; border-collapse: collapse; border:medium solid #000000; width:50%; text-align: left;" class="table table-bordered">
		<tr style="border:thin solid #6495ed; width: 50%; font-family: sans-serif; border:thin solid #6495ed; padding: 5px; text-align: center;">
			<td>id</td> <td>Nom</td><td>Code</td><td>SalaireBase</td><td>Action</td>
		</tr>
		...
		<tr style="border:thin solid #6495ed; width: 50%; font-family: sans-serif; border:thin solid #6495ed; padding: 5px; text-align: center; ">
			...
			<td>{{$grade->salaireBaseGrade}}</td>
			
			
			<td>
				<a href="{{route('grades.edit',$grade->idGrade)}}">Editer </a>
				<a href="{{route('grades.destroy',$grade->idGrade)}}">supprimer </a>
			</td>
		</tr>
		@endforeach
	</table>
