        ...
        <ul>
            ...
            <li class="dropdown"><a href="#">Ajouter<span>&rsaquo;</span></a>
                <ul>
                    ...
                    <li><a href="{{ route('retenues.create')}}">Retenue</a></li>
                </ul>
            </li> 
                            ...
                            <div class="col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1">
                                  ...
                                  <form action="{{route('employes.store') }}" method="POST" validate>
                                        ...
                                        <div class="form-group {{ $errors->has('nomEmploye') ? 'has-error' : '' }}">
                                              ...
                                              <input type="text" name="nomEmploye" value="{{old('nomEmploye')}}" id="name" class="form-control" required="required">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="text" name="prenomEmploye" value="{{old('prenomEmploye')}}" id="othername" class="form-control" required="required">
                                        </div>
                                        <div class="form-group">
                                              <label for="dateNaissance" class="control-label">Date de Naissance</label>
                                              <input type="date" name="dateNaissance" value="{{old('dateNaissance')}}" id="date" class="form-control" required="required">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="tel" name="telephoneEmploye" value="{{old('telephoneEmploye')}}" id="tel" class="form-control" required="required">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="text" name="matriculeEmploye" value="{{old('matriculeEmploye')}}" id="matricule" class="form-control" required="required">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="text" name="professionEmploye" value="{{old('professionEmploye')}}" id="profession" class="form-control" required="required">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="text" name="villeEmploye" value="{{old('villeEmploye')}}" id="ville" class="form-control" required="required">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="date" name="dateEmbauche" value="{{old('dateEmbauche')}}" id="dateEmbauche" class="form-control" required="required">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="text" name="situationMatrimonialeEmploye" value="{{old('situationMatrimonialeEmploye')}}" id="situ" class="form-control" required="required">
                                        ...
                                        <div class="form-group">
                                              ...
                                              <input type="email" name="emailEmploye" value="{{old('emailEmploye')}}" id="email" class="form-control" required="required">
