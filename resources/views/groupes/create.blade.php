	...
	<div class="container d-flex align-items-center justify-content-center">
                  <div class="row">
                        ...
                        <div class="col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1">
                              <h2 style="text-align: center !important;">Ajouter Nouveau Groupe</h2>
                              <form action="{{route('groupes.store') }}" method="POST" validate>
                                    {{ csrf_field() }}
                                    <div class="form-group {{ $errors->has('nomGroupe') ? 'has-error' : '' }}">
                                          <label for="nomGroupe" class="control-label">Nom Du Groupe</label>
                                          <input type="text" name="nomGroupe" value="{{old('nomGroupe')}}" id="nomGroupe" class="form-control" required="required">
                                          {!! $errors->first('nomGroupe', '<span class="help-block">:message</span>') !!}
                                    </div>
                                    <div class="form-group">
                                          <label for="montantBruteGroupe" class="control-label">Montant Brute Du Groupe</label>
                                          <input type="montantBruteGroupe" name="montantBruteGroupe" value="{{old('montantBruteGroupe')}}" id="montantBruteGroupe" class="form-control" required="required">
                                          {!! $errors->first('montantBruteGroupe', '<span class="help-block">:message</span>') !!}
                                    </div>
                                    <br>
                                    <div class="form-group">
